...
try:
    ...
    from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.acme_validation import Validation

except MODULE_EXCEPTIONS:
    module_dependency_error()


# DOCUMENTATION = 'https://opnsense.ansibleguy.net/en/latest/modules/acme_validation.html'
# EXAMPLES = 'https://opnsense.ansibleguy.net/en/latest/modules/acme_validation.html'
