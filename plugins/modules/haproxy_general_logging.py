...
try:
    ...
    from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.haproxy_general_logging import GeneralLogging
...
def run_module():
    ...
    module_wrapper(GeneralLogging(module=module, result=result))
