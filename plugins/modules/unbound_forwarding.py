...
try:
    ...
    from ansible_collections.oxlorg.opnsense.plugins.module_utils.main.unbound_forwarding import Forwarding
...
def run_module():
    ...
    module_wrapper(Forwarding(module=module, result=result))
